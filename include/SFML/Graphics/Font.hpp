...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Clears pre-rendered glyphs if they exceed max_items_bytes in size
    ///
    /// \param max_items_bytes How many bytes the pages can have
    ///
    ///
    ////////////////////////////////////////////////////////////
    void clearPages(size_t max_items_bytes) const;
